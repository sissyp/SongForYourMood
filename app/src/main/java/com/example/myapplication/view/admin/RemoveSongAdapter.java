...
public class RemoveSongAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{

    List<Song> data;
    Context context;

    public RemoveSongAdapter(List<Song> data, Context context) {
        this.data = data;
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new RemoveSongAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        final Song song = data.get(position);
        RemoveSongAdapter.ViewHolder customHolder = (RemoveSongAdapter.ViewHolder) holder;
